...
# Load data
path = '../../data/unet/family_machine/CB15-WT/'
proc = DataProcessor()

path_img_train = path + 'train/img/Caulobacter_WT-Raw.tif'
path_mask_train = path + 'train/mask/Caulobacter_WT_segmented.tif'
...
model.fit(x=[X_train,
          ...
          callbacks=[callback],
          shuffle=True)
model.save_weights('../../model_weights/family_machine/model_weights_CB15-WT.h5')
