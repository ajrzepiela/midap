...
# Load the data
path = '../../data/unet/well_plate/13B01/'
proc = DataProcessor()

path_img_train = [path + 'train/img/13B01dsRED_frame75_img.tif']
path_mask_train = [path + 'train/mask/13B01dsRED_frame75_mask.tif']
...
model.fit(x=[X_train,
          ...
          callbacks=[callback],
          shuffle=True)
model.save_weights('../../model_weights/well_plate/model_weights_13B01.h5')
